...
variable "final_snapshot_identifier_prefix" {
  description = "The prefix of your final DB snapshot when this DB cluster is deleted"
  type        = string
  default     = "final"
}
...
variable "instance_class" {
  ...
  validation {
    condition     = contains(["backbase", "medium"], var.instance_class)
    error_message = "Only medium values allowed"
  }
}
